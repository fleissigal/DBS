...
"undefined" == typeof window && "undefined" != typeof process ? TWEEN.now = function() {
        ...
        this.to = function(t, e) {
            ...
            var c, N, w;
            if (t < d) return !0;
            v === !1 && (null !== m && m.call(n, n), v = !0), N = (t - d) / a, N = N > 1 ? 1 : N, w = p(N);
            for (c in o)
                if (void 0 !== i[c]) {
                    var b = i[c] || 0,
                        L = o[c];
    ...
    function(t) {
        ...
        function a() {
            j = !0, E = void 0, N.enabled !== !1 && (document.removeEventListener("mousemove", r, !1), document.removeEventListener("mouseup", a, !1), N.dispatchEvent(q), F = B.NONE)
        }

        function s(t) {
            if (N.enabled !== !1 && N.noZoom !== !0 && F === B.NONE) {
        ...
        function c(t) {
            if (N.enabled !== !1 && N.noKeys !== !0 && N.noRotate !== !0) {
                switch (t.keyCode) {
                    case N.keys.UP:
                        m = !0;
                        break;
            ...
            if (N.enabled !== !1) {
                ...
                switch (t.touches.length) {
                    ...
                    case 2:
                        ...
                        Math.sqrt(n * n + i * i);
                        t.scale < 1 ? (N.object.fov = N.object.fov < N.maxFov ? N.object.fov + 1 : N.maxFov, N.object.updateProjectionMatrix()) : t.scale > 1 && (N.object.fov = N.object.fov > N.minFov ? N.object.fov - 1 : N.minFov, N.object.updateProjectionMatrix()), N.update(), N.dispatchEvent(Y);
                        break;
                    case 3:
                        if (N.noPan === !0) return;
        ...
        function d() {
            j = !0, E = void 0, N.enabled !== !1 && (N.dispatchEvent(q), F = B.NONE)
        }
        ...
        this.setLastQuaternion = function(t) {
            ...
            var i = T.length() * H;
            i = Math.max(this.minDistance, Math.min(this.maxDistance, i)), this.target.add(D), T.x = i * Math.sin(f) * Math.sin(p), T.y = i * Math.cos(f), T.z = i * Math.sin(f) * Math.cos(p), T.applyQuaternion(z), e.copy(this.target).add(T), this.object.lookAt(this.target), C = 0, I = 0, H = 1, D.set(0, 0, 0), (V.distanceToSquared(this.object.position) > 1e-7 || 8 * (1 - _.dot(this.object.quaternion)) > 1e-7) && (t !== !0 && this.dispatchEvent(Y), V.copy(this.object.position), _.copy(this.object.quaternion))
        }, this.reset = function() {
        ...
        var h = function(t) {
            ...
            d = function(t, e, i, o, a) {
                ...
                0 == n.screenOrientation ? (s = new THREE.Vector3(1, 0, 0), d.setFromAxisAngle(s, -r)) : 180 == n.screenOrientation ? (s = new THREE.Vector3(1, 0, 0), d.setFromAxisAngle(s, r)) : 90 == n.screenOrientation ? (s = new THREE.Vector3(0, 1, 0), d.setFromAxisAngle(s, r)) : n.screenOrientation == -90 && (s = new THREE.Vector3(0, 1, 0), d.setFromAxisAngle(s, -r)), u.multiply(d), u.multiply(p), c.set(i, e, -o, "YXZ"), t.setFromEuler(c), t.multiply(u), t.multiply(l.setFromAxisAngle(h, -a))
            };
        this.connect = function() {
            ...
            if (n.enabled !== !1) {
                ...
                d(n.camera.quaternion, e, o, r, a), this.alpha = e, t !== !0 && this.dispatchEvent(i)
            }
...
GSVPANO.PanoLoader = function(t) {
    ...
    function() {
        ...
        PANOLENS.TileGroup = function(t, e, n, i, o) {
            ...
            for (var t = this.offset - 1; t >= 0; t--) this.tileArray.indexOf(this.children[t]) !== -1 && (this.offset - t <= this.visibleDelta ? (this.children[t].visible = !0, new TWEEN.Tween(this.children[t].material).to({
            ...
            for (var t = this.offset + 1; t < this.children.length; t++) this.tileArray.indexOf(this.children[t]) !== -1 && (t - this.offset <= this.visibleDelta ? (this.children[t].visible = !0, new TWEEN.Tween(this.children[t].material).to({
    ...
    function() {
        ...
        PANOLENS.Viewer = function(t) {
            ...
            PANOLENS.Viewer.prototype.addUpdateCallback = function(t) {
                ...
                var n, i, o;
                if (this.raycasterPoint.x = (t.clientX - this.container.offsetLeft) / this.container.clientWidth * 2 - 1, this.raycasterPoint.y = 2 * -((t.clientY - this.container.offsetTop) / this.container.clientHeight) + 1, this.raycaster.setFromCamera(this.raycasterPoint, this.camera), this.panorama)
    ...
    function t(e, n, i) {
        ...
        13: [function(t, e, n) {
            function i(t, e) {
                ...
                var n = t.indexOf(" ");
                if (n === -1) throw new Error("no named row at line " + e);
            ...
            function o(t) {
                return t && 0 !== t.length ? 0 === t.indexOf('"') || 0 === t.indexOf("'") ? t.substring(1, t.length - 1) : t.indexOf(",") !== -1 ? r(t) : parseInt(t, 10) : ""
            }
        ...
        27: [function(t, e, n) {
            ...
            e.exports = function(t, e) {
                ...
                for (var n = "string" == typeof e.type ? e.type : "uint16", h = "number" == typeof e.count ? e.count : 1, c = e.start || 0, l = e.clockwise !== !1 ? a : s, u = l[0], d = l[1], p = l[2], f = 6 * h, E = t || new(i(n))(f), m = 0, v = 0; m < f; m += 6, v += 4) {
                    var g = m + c;
        ...
        37: [function(t, e, n) {
            (function(e) {
                ...
                o.TYPED_ARRAY_SUPPORT = void 0 !== e.TYPED_ARRAY_SUPPORT ? e.TYPED_ARRAY_SUPPORT : function() {
                    ...
                    function n(t, e, n) {
                        for (var i = -1, o = 0; n + o < t.length; o++)
                            if (t[n + o] === e[i === -1 ? 0 : o - i]) {
                                if (i === -1 && (i = o), o - i + 1 === e.length) return n + i
                            } else i = -1;
                        return -1
                    }
                ...
                o.prototype.slice = function(t, e) {
                    ...
                    return e || I(t, 1, this.length), 128 & this[t] ? (255 - this[t] + 1) * -1 : this[t]
